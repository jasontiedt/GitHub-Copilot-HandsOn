# Basic VPC Template
# Use this template as a starting point for AWS networking infrastructure
...
# AI Prompts for Enhancement:
# - "Add NAT gateway for private subnet internet access"
# - "Create additional subnets in multiple availability zones"
